		...
		class bd {
			...
			public function GetMedico($rut) {
				$medico =  Array();
				$respuesta =Array();
		
				$query="SELECT * FROM medico WHERE run=?";
			...
			public function GetPacientesMedico($rut) {
				$paciente =  Array();
				$respuesta = Array();
					$query="SELECT usuario.run , usuario.nombre , usuario.correo , usuario.fecha_nacimiento , usuario.direccion , usuario.ocupacion , usuario.previcion_salud FROM usuario Inner join fichamedica on fichamedica.usuario_run = usuario.run WHERE fichamedica.medico_run = ?";
			...
			public function GetPaciente($rut) {
				...
				$query="SELECT * FROM usuario WHERE run=?";
			...
			public function GetFichasPaciente($rut) {

				$fichas =  Array();
				$respuesta = Array();
					$query="SELECT * FROM fichamedica WHERE usuario_run=?";
			...
			public function GetFichaById($id) {
				...
				$fichas =  Array();
				$respuesta = Array();
					$query="SELECT * FROM fichamedica WHERE id=?";
			...
			public function GetAnamnesisRemotaById($id) {

				$AnamnesisRemotas =  Array();
				$respuesta = Array();
					$query="SELECT * FROM anamnesis_remota WHERE id=?";
			...
			public function GetExamenFisicoById($id) {

				$ExamenFisicos =  Array();
				$respuesta = Array();
					$query="SELECT * FROM examen_fisico  WHERE id=?";
